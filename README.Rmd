...
The goal of `helpdesk` is to create a simple api to query URL links embedded in DESCRPITION files of the `installed.packages` and return an search enabled datatable with active links of the relevant URLs.
